...
export const PrivatePolicy = () => {
  return (
    <div className='min-vh-100 p-5' style={{ backgroundColor: '#e9f2f9' }}>
      <h2>Privacy Policy for BCC Online Grading System</h2>
      <p>
        At BCC Online Grading System, accessible from http://localhost:3000/, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document contains types of
        information that is collected and recorded by BCC Online Grading System and how we use it.
      </p>
      <p>
      ...
      <p>
        ...
        website with regards to the information that they shared and/or collect in BCC Online
        Grading System. This policy is not applicable to any information collected offline or via
      ...
      <h2>Log Files</h2>
      <p>
        BCC Online Grading System follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, BCC Online Grading System uses "cookies". These cookies are used to
      ...
      <p>
        ...
        BCC Online Grading System.
      </p>
      <p>
        Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web
        Beacons that are used in their respective advertisements and links that appear on BCC Online
        Grading System, which are sent directly to users' browser. They automatically receive your
      ...
      <p>
        Note that BCC Online Grading System has no access to or control over these cookies that are
        used by third-party advertisers.
      </p>
      <h2>Third Party Privacy Policies</h2>
      <p>
        BCC Online Grading System's Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        BCC Online Grading System does not knowingly collect any Personal Identifiable Information
